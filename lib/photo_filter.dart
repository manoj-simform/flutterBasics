...
class PhotoFilterExample extends StatefulWidget {
  const PhotoFilterExample({Key? key}) : super(key: key);

  @override
  _PhotoFilterExampleState createState() => _PhotoFilterExampleState();
}

class _PhotoFilterExampleState extends State<PhotoFilterExample> {
  final _filters = [
    Colors.white,
    ...List.generate(
